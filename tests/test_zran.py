...
def test_seek_then_read_block(  testfile, nelems, niters, seed): ctest_zran.test_seek_then_read_block(  testfile, nelems, niters, seed)
...
def test_build_then_read(       testfile, nelems, seed):         ctest_zran.test_build_then_read(       testfile, nelems, seed)
