...
"""
    cdef char* buf2 = <char *> malloc(1000000 * sizeof(char))

    orig = os.urandom(1000000)
    f = BytesIO(orig)
    # cdef char* buf2 = str('.' * 1000000)
    bytes_read = zran._fread_python(buf2, 1, 1000000, <PyObject*>f)
    assert bytes_read == 1000000
    assert f.tell() == 1000000
